...
class UI
{
	...
	enum DsgnMenuItem //The items of the design menu (you should add more items)
	{
		...
		ITM_LAMP,		//Bulb item in menu
		ITM_CONNECTION,		//Connection item in menu
		ITM_BATTARY,		//Battary item in menu
	...
	enum SimMenuItem //The items of the simulation menu (you should add more items)
	{
		...
		ITM_VOLT,	//Voltage Simulate menu item
		ITM_AMPARE,	//Ampare Simulate menu item
...
public:
	...
	void DrawBattary(const GraphicsInfo& r_GfxInfo, bool selected = false) const;
	...
	void DrawExit(const GraphicsInfo& r_GfxInfo, bool selected = false) const;
	void DrawDelete(const GraphicsInfo& r_GfxInfo, bool selected = false) const;
	void DrawUndo(const GraphicsInfo& r_GfxInfo, bool selected = false) const;
	void DrawRedo(const GraphicsInfo& r_GfxInfo, bool selected = false) const;
